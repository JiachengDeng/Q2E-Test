...
class Voxelize(object):
    ...
    def __call__(self, coords, colors, labels):
        ...
        coords_aug, feats, labels, coords_raw = coords_aug[map_index], colors[map_index], labels[map_index], coords[map_index]
        
        return coords_aug, feats, labels, coords_raw, remap_index
